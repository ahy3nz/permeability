...
com = mdt.compute_center_of_mass(sub_traj)
center_z = com[0,2]
...
prm.plot_symmetrized_free_energy(output['sym_z'], output['dG_sym'], 
        output['dG_sym_err'],savefig=True)
prm.plot_sym_diffusion_coefficient_z(output['sym_z'], output['d_z_sym'], 
        output['d_z_sym_err'],savefig=True)
prm.plot_resistance_z(output['sym_z'], output['R_z'], output['R_z_err'], savefig=True)
prm.plot_sym_exp_free_energy(output['sym_z'], output['dG_sym'], output['dG_sym_err'], output['d_z_sym'], 
